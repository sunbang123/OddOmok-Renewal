...
public class CameraRaycastSpawnerTest : NetworkBehaviour
{
    ...
    private void HandleRaycastHit(RaycastHit hit)
    {
        ...
        if (Runner.IsClient)
        {
            // Runner.Spawn 호출 시 위치와 회전을 명시적으로 전달
            ...
            // 디버깅: 생성된 객체의 위치 확인
            Debug.Log("Spawned Object Position: " + spawnedPrefab.transform.position);
        }
        else
        {
